...
CREATE TABLE `system_revisions` (
  ...
  `field` varchar(191) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `cast` varchar(191) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `old_value` text COLLATE utf8mb3_unicode_ci,
  `new_value` text COLLATE utf8mb3_unicode_ci,
  `revisionable_type` varchar(191) COLLATE utf8mb3_unicode_ci NOT NULL,
...
-- Dump completed on 2024-12-05 17:31:44
