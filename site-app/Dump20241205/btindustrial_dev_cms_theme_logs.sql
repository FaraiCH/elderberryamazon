...
CREATE TABLE `cms_theme_logs` (
  ...
  `theme` varchar(191) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `template` varchar(191) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `old_template` varchar(191) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `content` longtext COLLATE utf8mb3_unicode_ci,
  `old_content` longtext COLLATE utf8mb3_unicode_ci,
...
-- Dump completed on 2024-12-05 17:36:11
