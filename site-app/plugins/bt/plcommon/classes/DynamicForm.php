                ...
                $output[] = '<div class="printpdfrow '. $css.'">
                    ...
                    if( $fieldSettings['type'] == 'radio' && count($fieldSettings['field_values']) ) {
                        ...
                        foreach($fieldSettings['field_values'] as $fieldValue) {
                            ...
                            $output[] = "<div class='form-check form-input-checkpdf'><input required class='form-check-input' $name type='radio' $optionAttribute value='" . $fieldValue['field_value_id'] . "'><label class='form-check-label'>" . $fieldValue['field_value_content'].'</label></div>';
