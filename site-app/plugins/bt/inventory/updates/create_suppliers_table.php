...
class CreateSuppliersTable extends Migration
{
    public function up()
    {
        Schema::create('bt_inventory_suppliers', function(Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
        ...
        Schema::table('bt_inventory_suppliers', function(Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bt_inventory_suppliers');
    }
}
