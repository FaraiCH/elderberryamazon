...
class CreateShareDataClosingsTable extends Migration
{
    public function up()
    {
        Schema::create('bt_jsedata_share_data_closings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bt_jsedata_share_data_closings');
    }
}
