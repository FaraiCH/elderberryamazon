...
$(document).ready(function(){
    ...
    function addseconditemjs(){
      ...
      var item = '<td>'+second_itemcount+'</td><td><select attrid="'+second_itemcount+'" title="Item '+second_itemcount+': Product" name="catalogue_'+second_itemcount+'" id="catalogue_'+second_itemcount+'" class="select_search itemfrm form-control">'+$("#addseconditem_product").html()+'</select></td>';
...
function addseconditemjs_load(product_id,units){
      ...
      if(checkMe == false)
      {
          ...
          item += '<td><input style="width:100%; text-align: center;" value="1.00" title="Item '+second_itemcount+': Price" step="0.01" name="catunitprice_'+second_itemcount+'" id="catunitprice_'+second_itemcount+'" type="number" class="itemfrm"/></td>';
          item += '<td><input style="width:100%; text-align: center;" value="1" title="Item '+second_itemcount+': Units" name="catalogue_units_'+second_itemcount+'" id="catalogue_units_'+second_itemcount+'" type="number" class="itemfrm"/></td>';
          item += '<td><a for="tritem_'+second_itemcount+'" class="btn btn-primary btn-sm removeitem py-0" style="color:#fff"><i class="fa fa-trash"></i></a></td>';
          item = '<tr id="tritem_'+second_itemcount+'" tdcount="'+second_itemcount+'">'+item+'</tr>';
