...
/**
 * View Scrap Data Backend Controller
 */
class ViewScrapData extends Controller
{
    public $implement = [
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Bt.Reporting', 'reporting', 'viewscrapdata');
    }

    public function onScrapExport()
    {
