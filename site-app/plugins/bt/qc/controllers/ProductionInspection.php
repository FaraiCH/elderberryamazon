...
/**
 * Production Inspection Backend Controller
 */
class ProductionInspection extends Controller
{
    public $pageTitle = "QC";
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Bt.QC', 'qc', 'productioninspection'); // has to be uppercase plugin name always
...
//            }
        ...
        $current = Carbon::now();
        $this->vars['today'] = ControlSheetModel::where('created_at','>', $current->addDays(-24))->orWhere('opendate', Carbon::today())->where('active', 0)->get();
