...
use Model;
use BackendAuth;
use Bt\SHEQ\Models\Sub as SubFolderModel;
/**
 * Document Model
 */
class Document extends Model
{
     ...
     */
    public $table = 'bt_sheq_documents';
    ...
    public $belongsTo = [
        ...
        'mainfolder' =>['Bt\SHEQ\Models\Category','key'=>'category_id'],
        'subfolder' =>['Bt\SHEQ\Models\Sub','key'=>'sub_id'],
