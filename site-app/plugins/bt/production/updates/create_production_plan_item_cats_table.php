...
/**
 * CreateProductionPlanItemCatsTable Migration
 */
class CreateProductionPlanItemCatsTable extends Migration
{
    public function up()
    {
        Schema::create('bt_production_production_plan_item_cats', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bt_production_production_plan_item_cats');
    }
}
